...
function searchJobs(titleSearch, locationSearch, jobs) {
...
document.getElementById("btn").addEventListener("click", function () {
  ...
  const locationSearch = document.getElementById("searchLocation").value;

  const result = searchJobs(titleSearch, locationSearch, jobs);

  const containerList = document.getElementById("container-list");

  if (result.count === 0) {
    containerList.innerHTML = "<p>No results found</p>";
  } else {
